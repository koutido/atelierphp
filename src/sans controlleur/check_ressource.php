...
function booking($room_number, $email, $start_date, $start_month, $start_year, $start_hour, $start_minute,
	$end_date, $end_month, $end_year, $end_hour, $end_minute)
{
	include "commun/connexion.inc.php";
	$sql="INSERT INTO booking (room_number, email, start_date, start_month, start_year, start_hour, 
	start_minute, end_date, end_month, end_year, end_hour, end_minute)
	VALUES ($room_number, '$email', $start_date, $start_month, $start_year, $start_hour, $start_minute,
	$end_date, $end_month, $end_year, $end_hour, $end_minute)";
...
if(free($room_number, $start_date, $start_month, $start_year, $start_hour, $start_minute, 
		$end_date, $end_month, $end_year, $end_hour, $end_minute)){
	booking($room_number, $email, $start_date, $start_month, $start_year, $start_hour, $start_minute,
	$end_date, $end_month, $end_year, $end_hour, $end_minute);
}
else {
