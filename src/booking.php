...
function verif_champs(){
	if (document.forms[0].room_number.value.length<1){
		alert("Veuillez sélectionner une salle");
		document.forms[0].room_number.focus();
		return false;
	}
...
<br><br/>
<form action="check_ressource.php" method="post" onSubmit="return verif_formulaire()">
<table> 
<tr>
	<td>Salle</td>
	<td>
